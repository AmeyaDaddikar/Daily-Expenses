...
public class MainPage extends JFrame {
	...
	public MainPage() {
		...
		lblDailyExpenses.setFont(new Font("Rockwell", Font.ITALIC, 28));
		lblDailyExpenses.setBounds(74, 40, 233, 40);
		contentPane.add(lblDailyExpenses);
		
		JLabel lblExpenses = new JLabel("EXPENSES :");
		lblExpenses.setFont(new Font("Myanmar Text", Font.ITALIC, 20));
		...
		lblIncome.setFont(new Font("Myanmar Text", Font.ITALIC, 20));
		...
		lblTransfer.setFont(new Font("Myanmar Text", Font.ITALIC, 20));
		lblTransfer.setBounds(61, 291, 118, 28);
		contentPane.add(lblTransfer);
		
		JLabel lblBalance = new JLabel("BALANCE :");
		lblBalance.setHorizontalAlignment(SwingConstants.CENTER);
		lblBalance.setFont(new Font("Myanmar Text", Font.ITALIC, 20));
		...
		lblExpense.setFont(new Font("Myanmar Text", Font.ITALIC, 20));
		...
		lblIncome_1.setFont(new Font("Myanmar Text", Font.ITALIC, 20));
		...
		lblTransfer_1.setFont(new Font("Myanmar Text", Font.ITALIC, 20));
		...
		lblBalance_1.setFont(new Font("Myanmar Text", Font.ITALIC, 20));
		...
		lblPreviousTransactions.setFont(new Font("Rockwell", Font.ITALIC, 25));
		...
		lblTransactions.setFont(new Font("Rockwell", Font.ITALIC, 25));
		lblTransactions.setBounds(418, 73, 233, 40);
		contentPane.add(lblTransactions);
		
		JLabel label = new JLabel("1. ");
		label.setHorizontalAlignment(SwingConstants.LEFT);
		label.setFont(new Font("Myanmar Text", Font.ITALIC, 20));
		label.setBounds(418, 149, 233, 28);
		contentPane.add(label);
		
		JLabel label_1 = new JLabel("2.");
		label_1.setHorizontalAlignment(SwingConstants.LEFT);
		label_1.setFont(new Font("Myanmar Text", Font.ITALIC, 20));
		label_1.setBounds(418, 190, 233, 28);
		contentPane.add(label_1);
		
		JLabel label_2 = new JLabel("3.");
		label_2.setHorizontalAlignment(SwingConstants.LEFT);
		label_2.setFont(new Font("Myanmar Text", Font.ITALIC, 20));
		label_2.setBounds(418, 230, 233, 28);
		contentPane.add(label_2);
		
		JLabel label_3 = new JLabel("4.");
		label_3.setHorizontalAlignment(SwingConstants.LEFT);
		label_3.setFont(new Font("Myanmar Text", Font.ITALIC, 20));
		label_3.setBounds(418, 278, 233, 28);
		contentPane.add(label_3);
		
		JLabel label_4 = new JLabel("5.");
		label_4.setHorizontalAlignment(SwingConstants.LEFT);
		label_4.setFont(new Font("Myanmar Text", Font.ITALIC, 20));
		label_4.setBounds(418, 324, 233, 28);
		contentPane.add(label_4);
		
		JLabel label_5 = new JLabel("6.");
		label_5.setHorizontalAlignment(SwingConstants.LEFT);
		label_5.setFont(new Font("Myanmar Text", Font.ITALIC, 20));
		label_5.setBounds(418, 363, 233, 28);
		contentPane.add(label_5);
		
		JLabel label_6 = new JLabel("7.");
		label_6.setHorizontalAlignment(SwingConstants.LEFT);
		label_6.setFont(new Font("Myanmar Text", Font.ITALIC, 20));
		...
		lblDisplayGraphs.setFont(new Font("Rockwell", Font.ITALIC, 28));
		lblDisplayGraphs.setBounds(712, 40, 233, 40);
		...
		btnPieChart.setFont(new Font("Myanmar Text", Font.BOLD | Font.ITALIC, 16));
		...
		btnLineGraph.setFont(new Font("Myanmar Text", Font.BOLD | Font.ITALIC, 16));
		...
		btnViewAll.setFont(new Font("Myanmar Text", Font.BOLD | Font.ITALIC, 16));
		...
		btnAddIncome.setFont(new Font("Myanmar Text", Font.BOLD | Font.ITALIC, 16));
		...
		btnAddExpense.setFont(new Font("Myanmar Text", Font.BOLD | Font.ITALIC, 16));
