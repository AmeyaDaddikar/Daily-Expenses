			...
			public void actionPerformed(ActionEvent e) {
			    if(e.getSource() == btnAddExpense) {
					...
					try {
						...
						JOptionPane.showMessageDialog(null,"Enter amount in decimal format only (with only digits and decimal point)") ;
						return ;
					}
					System.out.println(amount);
					System.out.println(textArea.getText().toString());
                    String description = (textArea.getText().toString());
					Expense ex = new Expense(description, amount, 0, null);
